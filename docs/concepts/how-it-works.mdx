...
the definition. Modified views that depend on one another remain in one migration
batch and are ordered from provider to dependent in both up and down migrations.
